...
export async function verify2FACode(code: string, tempToken: string): Promise<{ success: boolean; error?: string }> {
  try {
    ...
    return { success: false, error: "Erreur réseau lors de la validation 2FA" };
  }
}
