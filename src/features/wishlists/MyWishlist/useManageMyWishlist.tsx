...
export const useManageMyWishlist = (navigate: NavigateFunction) => {
    ...
    const [confirmType, setConfirmType] = useState<
        "wish" | "wishlist" | "subscriber" | "leave" | null
    >(null);
    ...
    const leaveWishlistMutation = useMutation({
        mutationFn: () => leaveWishlist(id ?? ""),
        onSuccess: () => {
            queryClient.invalidateQueries({ queryKey: ["wishlists"] });
            navigate("/my-wishlists");
        },
    ...
    const handleLeaveWishlistCollaboration = () => {
        leaveWishlistMutation.mutate();
    };
