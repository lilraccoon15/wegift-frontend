...
import { useCancelFriendRequest } from "../../features/profile/MyProfile/MyProfileHelpers";
          ...
          <div className="pending-details">
            ...
            {direction === "received" ? (
              <ActionButtons
                ...
                onAccept={() => console.log("Accepter", profile.id)}
                onDecline={() => console.log("Refuser", profile.id)}
                variant="friendship"
              />
            ) : (
              <ActionButtons
