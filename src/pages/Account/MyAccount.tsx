          ...
          {currentView === "default" && (
            <ul>
              <Link to="/account/edit-email">
                <li>
                  <span>
                    <i className="fa-solid fa-at"></i> Modifier mon adresse
                    email
                  </span>
              ...
              <Link to="/account/edit-password">
                <li>
                  <span>
                    <i className="fa-solid fa-lock"></i> Modifier mon mot de
                    passe
                  </span>
                  <i className="fa-solid fa-chevron-right"></i>
                </li>
              ...
              <Link to="/account/2FA">
                <li>
                  <span>
                    <i className="fa-solid fa-key"></i> Double authentification
                  </span>
                  <i className="fa-solid fa-chevron-right"></i>
                </li>
              </Link>
              <Link to="/account/google-link">
                <li>
                  <span>
                    <i className="fa-solid fa-link"></i> Connexion avec Google
                  </span>
                  <i className="fa-solid fa-chevron-right"></i>
                </li>
              </Link>
              <Link to="/account/preferences">
                <li>
                  <span>
                    <i className="fa-solid fa-gears"></i> Préférences
                  </span>
                  <i className="fa-solid fa-chevron-right"></i>
                </li>
              </Link>
